...
MODES={'medical-discovery-inputs':'hpc.medical_discovery','medical-discovery':'hpc.medical_discovery',
       ...
       'inventory':'hpc.workstream_inventory','publish':'hpc.multiclass_inputs','evaluate':'hpc.evaluate_reference',
